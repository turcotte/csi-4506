...
Voici une liste de sites web proposant des jeux de données pertinents pour les concepts du cours, afin d’améliorer vos compétences et votre intuition en analyse de données.

## Jeux de données petits à moyens, très adaptés aux étudiants

- [UCI Machine Learning Repository](https://archive.ics.uci.edu/)
- [Jeux de données jouets de scikit-learn](https://scikit-learn.org/stable/datasets/toy_dataset.html)

## Jeux de données plus grands

- [OpenML](https://www.openml.org/), s’intègre directement avec scikit-learn
...
- [Jeux de données Kaggle](https://www.kaggle.com/datasets)
  - Kaggle, une plateforme appartenant à Google, sert de communauté en ligne destinée aux scientifiques des données et aux praticiens de l’apprentissage automatique. Elle facilite la participation à des compétitions de science des données, la collaboration sur divers projets, et fournit un accès à des jeux de données variés. De plus, les utilisateurs peuvent construire des modèles en utilisant ses outils basés sur le web.
  - Les jeux de données publics provenant de Kaggle ou du Web ne sont pas automatiquement fiables du seul fait qu’ils sont faciles d’accès, largement partagés ou cités dans des articles scientifiques. Des rapports récents ont démontré que certains jeux de données de santé couramment utilisés contiennent des valeurs irréalistes ou douteuses, ce qui peut fausser les analyses et mener à des modèles d’IA trompeurs. Les étudiants doivent évaluer de manière critique la provenance, la documentation et la plausibilité des données avant toute utilisation, et éviter de s’appuyer sur des sources invérifiables pour leurs travaux académiques sérieux.
...
- [ML Contests](https://mlcontests.com)
  - **ML Contests** est un répertoire organisé de concours d’apprentissage automatique, de science des données et de robotique, actifs, à venir ou passés, avec des filtres par technique, domaine d’application, plateforme et cagnotte. Il aide les praticiens à découvrir rapidement les défis pertinents sur les principales plateformes.
  - [The State of Machine Learning Competitions: 2025 Edition](https://mlcontests.com/state-of-machine-learning-competitions-2025/) : Ce rapport peut vous aider à voir quelles bibliothèques et approches de modélisation sont les plus largement utilisées dans les solutions les plus performantes, ancrant votre apprentissage dans la pratique actuelle. Il fournit également un aperçu des flux de travail réalistes, des budgets de calcul et des normes d’évaluation dans le machine learning compétitif.
...
- [Cohere annonce son expansion à Montréal](https://www.lapresse.ca/affaires/techno/2025-07-03/intelligence-artificielle/cohere-annonce-son-expansion-a-montreal.php) par Alain McKenna dans **La Presse+**, 2025-07-03.
- [Shopify CEO says no new hires without proof AI can’t do the job](https://www.theverge.com/news/644943/shopify-ceo-memo-ai-hires-job), **The Verge**, Jay Peters, 7 avril 2025.
- [L’écosystème de l’IA au Canada : coup d’oeil sur les compétences recherchées et les tendances](https://ictc-ctic.ca/fr/rapports/lecosysteme-de-lia-au-canada-coup-doeil-sur-les-competences-recherchees-et-les-tendances?utm_source=chatgpt.com), **CTIC**, 1er avril, 2025.
- [AI software engineers make \$100,000 more than their colleagues.](https://qz.com/ai-software-engineers-make-100k-more-than-colleagues-a-1851496766) **Quartz**. MAJ 23 mai 2024.
- [Le Canada est le leader mondial de la concentration de talents en IA.](https://www2.deloitte.com/ca/fr/pages/communiques-de-presse/articles/impact-and-opportunities.html) **Deloitte** Press Release. 23 septembre 2023.
- [Don’t fear AI. It will lead to long-term job growth.](https://www.weforum.org/agenda/2020/10/dont-fear-ai-it-will-lead-to-long-term-job-growth/) **World Economic Forum**, 26 octobre 2020.
- [Talent and workforce effects in the age of AI.](https://www2.deloitte.com/us/en/insights/focus/cognitive-technologies/ai-adoption-in-the-workforce.html) **Deloitte** Insights, 3 mars 2020.

# Baladodiffusions audio et vidéo
...
- [Are We Thinking Correctly About **AI Intelligence**? The Joy of Why](https://www.youtube.com/watch?v=cSZo8GZIUYI), publié 2026-08-20
...
- [Responsible AI](https://www.caiac.ca/en/conferences/canadianai-2026/responsible-ai), un événement de [Canadian AI](https://www.caiac.ca)
- [AI for Good](https://aiforgood.itu.int)
- [We’re Doing AI All Wrong. Here’s How to Get It Right](https://www.youtube.com/watch?v=Bl-vPf_IAoA), TED Talk, Sasha Luccioni, 10m 31s, 2025-12-01.

# Étique

- [Evitable](https://evitable.com/) - informing and organizing the public around societal-scale risks and harms of AI
- [Un manifeste de la firme Palantir suscite la controverse](https://www.lapresse.ca/international/etats-unis/2026-04-28/intelligence-artificielle/un-manifeste-de-la-firme-palantir-suscite-la-controverse.php) Marc Thibodeau, La Presse, 2026-04-28.
...
- [Espoirs et dérives de l’intelligence artificielle avec Yoshua Bengio \| 24•60](https://www.youtube.com/watch?v=vTpt8ZX7SMI), Radio-Canada, 2025-09-02.
...
- [Stephanie Hare interview Yoshua Bengio](https://www.youtube.com/watch?v=3cFk225CyXU), BBC AI Decoded, 2025-03-06
- [What Happens When Robots Don’t Need Us Anymore?](https://www.youtube.com/watch?v=sK5_pQV_QEA), Bloomberg, 2024-11-11
- [Slaughterbots - if human: kill()](https://www.youtube.com/watch?v=9rDo1QxI260), Future of Life Institute, 2021-11-30
- [Slaughterbots](https://www.youtube.com/watch?v=9CO6M2HsoIA), Stop Autonomous Weapons, 2017-11-12

# Battage publicitaire

- [Une « révolution » s’en vient](https://www.lapresse.ca/affaires/intelligence-generale-artificielle/objectif-2030-vous-remplacer/2025-06-21/intelligence-generale-artificielle/une-revolution-s-en-vient.php), [Se protéger d’une mauvaise IA… par une bonne IA](https://www.lapresse.ca/affaires/intelligence-generale-artificielle/objectif-2030-vous-remplacer/2025-06-21/intelligence-artificielle-generative/se-proteger-d-une-mauvaise-ia-par-une-bonne-ia.php) et [La fin annoncée de l’iPhone](https://www.lapresse.ca/affaires/intelligence-generale-artificielle/objectif-2030-vous-remplacer/2025-06-21/intelligence-artificielle-agentique/la-fin-annoncee-de-l-iphone.php) par Alain McKenna dans La Presse+, 2025-06-21.
...
- [Association pour l’intelligence artificielle au Canada](https://www.caiac.ca/fr/home)
...
- **Adapté de:** Mitchell, M. (2025). [Artificial intelligence learns to reason](https://www.science.org/doi/10.1126/science.adw5211). Science, 387(6740):eadw5211.
...
> ------------------------------------------------------------------------
>
> Étonnamment, **Open AI o3** produit une réponse incorrecte. Des résultats similaires ont été obtenus, au moment de la rédaction, en utilisant Google Gemini 2.5 Flash et Pro.
...
- **Adapté de:** [Why AI can’t spell ‘strawberry’](https://techcrunch.com/2024/08/27/why-ai-cant-spell-strawberry/)
...
- **Adapté de:** [Gary Marcus’s post on X 2024-02-08](https://twitter.com/garymarcus/status/1755476468157833593):
...
> **ChatGPT**
>
> ![](assets/images/2024-02-18_DALLE_No_Elephant.png)
>
