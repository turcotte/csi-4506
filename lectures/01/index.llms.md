...
- Voici la [présentation](slides.llms.md) ([PDF](slides.pdf), [Jupyter Notebook](slides.ipynb))
...
- Pour saisir pleinement l’évolution de l’intelligence artificielle (IA), il est important de se pencher sur son histoire, surtout à une époque où nous atteignons un pic d’optimisme spéculatif. En effet, on affirme souvent que **l’avènement de l’intelligence artificielle générale (IAG) est proche**. Cette vidéo révélera que **de telles prédictions ont été régulièrement émises depuis les années 1950**.
